...
public void readCommandTest1() {
	doNothing().when(spy1).returnTheInfo(1,"SV2.5-HV2.0");
...
doNothing().when(spy1).returnTheInfo(anyInt(),anyString());
spy1.readCommand("O1\r");
spy1.readCommand("t36380000000300000D500010\r");
verify(spy1,times(1)).open();
try {
verify(spy1,times(1)).sendStandardFrame("t36380000000300000D500010");
} catch (Exception e) {
...
doNothing().when(spy1).returnTheInfo(anyInt(),anyString());
spy1.readCommand("O1\r");
spy1.readCommand("t3F380000000300000D500010\r");
verify(spy1,times(1)).open();
try {
verify(spy1,times(1)).sendStandardFrame("t3F380000000300000D500010");
} catch (Exception e) {
// TODO Auto-generated catch block
e.printStackTrace();
}
...
doNothing().when(spy1).returnTheInfo(anyInt(),anyString());
spy1.readCommand("O1\r");
spy1.readCommand("T0000036380000000300000D500000\r");
verify(spy1,times(1)).open();
try {
verify(spy1,times(1)).sendExtendedFrame("T0000036380000000300000D500000");
} catch (Exception e) {
// TODO Auto-generated catch block
e.printStackTrace();
}
...
doNothing().when(spy1).returnTheInfo(anyInt(),anyString());
spy1.readCommand("O1\r");
spy1.readCommand("T0000036380000000300000D500010\r");
verify(spy1,times(1)).open();
try {
verify(spy1,times(1)).sendExtendedFrame("T0000036380000000300000D500010");
} catch (Exception e) {
// TODO Auto-generated catch block
e.printStackTrace();
}
...
doNothing().when(spy1).returnTheInfo(anyInt(),anyString());
spy1.readCommand("O1\r");
spy1.readCommand("t36380000000300000D500000\r");
verify(spy1,times(1)).open();
try {
verify(spy1,times(1)).sendStandardFrame("t36380000000300000D500000");
} catch (Exception e) {
// TODO Auto-generated catch block
e.printStackTrace();
}
...
doNothing().when(spy1).returnTheInfo(anyInt(),anyString());
spy1.readCommand("O1\r");
spy1.readCommand("T000003F380000000300000D500010\r");
verify(spy1,times(1)).open();
try {
verify(spy1,times(1)).sendExtendedFrame("T000003F380000000300000D500010");
} catch (Exception e) {
// TODO Auto-generated catch block
e.printStackTrace();
}
